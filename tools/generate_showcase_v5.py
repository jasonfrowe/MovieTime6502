...
def main() -> None:
    parser = argparse.ArgumentParser(description="V5 Amiga-style showcase generator")
    sub = parser.add_subparsers(dest="cmd", required=True)

    enc = sub.add_parser("encode", help="Generate the showcase into MT62 format")
    enc.add_argument("--output", default="SHOWCASE_V5.BIN", help="Output stream filename")
    ...
    ver.add_argument("--debug-dir", default="debug_verify_v5", help="Output dir for PNGs")
